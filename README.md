...
In this lab, two Python classes were created and tested:

### Book class

-Initializes with title and page_count.
-Validates that page_count is an integer.
-Includes a turn_page() method that prints a message.

### Coffee class

-Initializes with size and price.
-Validates that size is either Small, Medium, or Large.
-Includes a tip() method that prints a message and increases price by 1
